...
dtack_drawing_mode_wallpaper_c.prototype = new dtack_drawing_mode_base_c();
										// override the constructor
dtack_drawing_mode_wallpaper_c.prototype.constructor = dtack_drawing_mode_wallpaper_c;

// -------------------------------------------------------------------------------
// constructor

function dtack_drawing_mode_wallpaper_c(page)
{
										// we are not doing a prototype construction?
  if (arguments.length > 0)
  {
	var F = "dtack_drawing_mode_wallpaper_c";
...
// -------------------------------------------------------------------------------
dtack_drawing_mode_wallpaper_c.prototype.initialize = function(definition_object)
{
  var F = "initialize";
...
dtack_drawing_mode_wallpaper_c.prototype.activate = function(currently_active_mode_object)
{
  var F = "activate";
  ...
  this.page.wallpaper.apply_definition_data(
