...
dtack__interaction__cascading_json_choicelist_pulldown_relation_c.prototype = new dtack_base2_c();

                                        // provide an explicit name for the base class
dtack__interaction__cascading_json_choicelist_pulldown_relation_c.prototype.base = dtack_base2_c.prototype;

										// override the constructor
dtack__interaction__cascading_json_choicelist_pulldown_relation_c.prototype.constructor = dtack__interaction__cascading_json_choicelist_pulldown_relation_c;

// -------------------------------------------------------------------------------
// constructor (functioning as a prototype, this constructor cannot take arguments)

function dtack__interaction__cascading_json_choicelist_pulldown_relation_c(dtack_environment, classname)
{
										// we are not doing a prototype construction?
  if (arguments.length > 0)
  {
	var F = "dtack__interaction__cascading_json_choicelist_pulldown_relation_c";

										/* call the base class constructor helper */
	dtack__interaction__cascading_json_choicelist_pulldown_relation_c.prototype.base.constructor.call(
	  this,
	  dtack_environment,
...
dtack__interaction__cascading_json_choicelist_pulldown_relation_c.prototype.activate = function(
  page, 
  json_objects, 
  input_selector1, 
  initial1_value, 
  ...
  subobjects2_fieldname)
{
  ...
  this.select2 = new dtack__interaction__cascading_json_choicelist_relation_c(this.dtack_environment);
...
dtack__interaction__cascading_json_choicelist_pulldown_relation_c.prototype.is_operator_trigger = function(trigger_object)
{
...
dtack__interaction__cascading_json_choicelist_pulldown_relation_c.prototype.poke_json2_objects = function(options)
{
