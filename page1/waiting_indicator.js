...
dtack_page_waiting_indicator_c.prototype = new dtack_base2_c();

                                        // provide an explicit name for the base class
dtack_page_waiting_indicator_c.prototype.base = dtack_base2_c.prototype;

										// override the constructor
dtack_page_waiting_indicator_c.prototype.constructor = dtack_page_waiting_indicator_c;

// -------------------------------------------------------------------------------
// constructor (functioning as a prototype, this constructor cannot take arguments)

function dtack_page_waiting_indicator_c(dtack_environment, classname)
{
										// we are not doing a prototype construction?
  if (arguments.length > 0)
  {
	var F = "dtack_page_waiting_indicator_c";

										/* call the base class constructor helper */
	dtack_page_waiting_indicator_c.prototype.base.constructor.call(
	  this,
	  dtack_environment,
...
dtack_page_waiting_indicator_c.prototype.show_initial = function(options)
{
  ...
  $("BODY").append(
"<div class=\"dtack_utility_waiting_indicator_div\">\n" +
...
dtack_page_waiting_indicator_c.prototype.hide_initial = function()
{
...
dtack_page_waiting_indicator_c.prototype.show = function(text, options)
{
  var F = "show"; 
...
//  this.debug(F, "showing waiting indicator at window size " + window_width + "x" + window_height);
  ...
  //$(".dtack_utility_waiting_indicator_div").css({"width": window_width + "px"});
  //$(".dtack_utility_waiting_indicator_div").css({"height": window_height + "px"});
...
// ------------------------------------------------------------------------------
dtack_page_waiting_indicator_c.prototype.hide = function()
{
  var F = "hide";
                                                        
  this.debug(F, "hiding waiting indicator");
