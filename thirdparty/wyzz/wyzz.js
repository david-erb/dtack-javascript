...
editstyle = '../../javascript/wyzzstyles/editarea.css';

// Do we want to try to clean the code to emulate xhtml? 1=Yes, 0=No
xhtml_out = 0;

// Style Sheet
document.write('<link rel="stylesheet" type="text/css" href="../../javascript/wyzzstyles/style.css">\n');

// TOOLBARS ARRAYS
// Order of available commands in toolbar
// Remove from this any buttons not required in your application
/*var buttonName = new Array("font","headers","separator","bold","italic","underline","strikethrough","separator","cut","copy","paste","separator","subscript","superscript","separator","justifyleft","justifycenter","justifyright","justifyfull","indent","outdent","separator","insertunorderedlist","insertorderedlist","separator","link","insertimage","separator","undo","redo","forecolor","separator","inserthorizontalrule","separator","removeformat","separator","upsize","downsize","separator","htmlmode","separator","help");
*/
var buttonName2 = new Array("bold","italic","underline","separator","cut","copy","paste","separator","subscript","superscript","separator","justifyleft","justifycenter","justifyright","justifyfull","indent","outdent","separator","insertunorderedlist","insertorderedlist","separator","undo","redo","forecolor","separator","inserthorizontalrule","separator","removeformat","separator","htmlmode","separator","help");

// Order of available commands in toolbar2
// Remove from this any buttons not required in your application
var buttonName1 = new Array("forecolor","separator","inserthorizontalrule","separator","removeformat","separator","upsize","downsize","separator","htmlmode","separator","help");
...
function make_wyzz(textareaID) {
  ...
  if (wyzz_list != undefined)
    wyzz_list[wyzz_list.length] = textareaID;
  ...
  for (btn in buttonName2) {
    ...
    if(buttonName2[btn] == "separator") {
      ...
      toolbar2 += '<td style="width: 22px;"><img src="../../javascript/wyzzicons/' +buttonName2[btn]+ '.gif" border=0 unselectable="on" title="' +buttonName2[btn]+ '" id="' +buttonName2[btn]+ '" class="button" onClick="formatText(this.id,\'' + n + '\');" onmouseover="if(className==\'button\'){className=\'buttonOver\'};" onmouseout="if(className==\'buttonOver\'){className=\'button\'};" unselectable="on" width="20" height="20"></td>';
      }
  }
  toolbar2 += '<td>&nbsp;</td></tr>';
...
// the foreground color picker
  ...
  toolbar2 += '<div id="colorpicker' + n + '" class="colorpicker" style="display:none">';
    ...
    toolbar2 += '<img class="closebutton" src="../../javascript/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'colorpicker' + n + '\')"></div>';
  ...
  toolbar2 += '<img class="closebutton" src="../../javascript/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'colorbackpicker' + n + '\')"></div>'; 
  // the font picker
  ...
  toolbar2 += '<img class="closebutton" src="../../javascript/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'fontpicker' + n + '\')"></div>'; 
  ...
  toolbar2 += '</tr></table><br><img class="closebutton" src="../../javascript/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'specialpicker' + n + '\')"></div>'; 
  // the header picker
  ...
  toolbar2 += '<img class="closebutton" src="../../javascript/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'headerpicker' + n + '\')"></div>'; 
  ...
  toolbar2 += '<div class="help"><h4><img src="../../javascript/wyzzicons/wyzzicon.gif" align="middle">Wyzz v' + version + '</h4><br>&copy; 2007 <a href="http://www.wyzz.info" target=_blank>www.wyzz.info</a><br><br></div>';
  toolbar2 += '<img class="closebutton" src="../../javascript/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'helpbox' + n + '\')"></div></td></tr></table>';   
...
function wyzz_list_update()
{
  if (wyzz_list != undefined)
  {
    var n = wyzz_list.length;
    var i;
    for (i=0; i<n; i++)
      updateTextArea(wyzz_list[i]);
  }
}
